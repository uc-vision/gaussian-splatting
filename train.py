    ...
    for iteration in range(first_iter, opt.iterations + 1):     
        ...
        with torch.no_grad():
            ...
            if iteration < opt.densify_until_iter:
                ...
                densification_interval = opt.densification_interval * (1 -t) + opt.final_densify_interval * t

                if iteration >= opt.densify_from_iter and iters_since_densification < densification_interval == 0:
                    iters_since_densification = 0
